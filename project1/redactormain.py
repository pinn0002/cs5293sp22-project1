...
def redactedstats(input_files,text_stat):
    if input_files.stats == "stdout":
        ...
        statsfile = open(input_files.stats, '')
    try:
        li = []
